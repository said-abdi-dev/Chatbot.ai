...
VALUES
    ...
    ('The "garbage collector" is a component in Java that automatically manages memory by identifying and reclaiming unused objects, preventing memory leaks and improving program efficiency.'),
